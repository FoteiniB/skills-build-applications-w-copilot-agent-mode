...
import logo from './logo.svg'; // Use your logo or replace with octofitapp-small if available
      ...
      <nav className="navbar navbar-expand-lg navbar-dark mb-4">
        <div className="container-fluid">
          <div className="octofit-logo">
            <img src={logo} alt="Octofit Logo" className="d-inline-block align-top" style={{height: '40px', marginRight: '10px'}} />
